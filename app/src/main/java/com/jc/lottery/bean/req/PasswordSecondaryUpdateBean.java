 ...
 * @ author: lr
 */
public class PasswordSecondaryUpdateBean {
    ...
    public PasswordSecondaryUpdateBean(String accountName, String oldPassword, String newPassword) {
        this.interfaceCode = "secondaryUpdate";
