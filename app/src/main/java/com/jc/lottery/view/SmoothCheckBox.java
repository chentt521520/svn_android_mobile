...
import com.jc.lottery.util.CompatUtils;

/**
 * Created by LR on 2019/5/14.
 */
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED   = Color.parseColor("#00923d");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#00923d");
