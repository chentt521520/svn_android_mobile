 ...
 * 投注列表页面
 */
public class VictoryBettingRecordActivity extends BaseActivity {
    ...
    private List<VictoryBettingBean.BettingList> payListBeans = new ArrayList<VictoryBettingBean.BettingList>();
    ...
    public int getLayoutId() {
        return R.layout.activity_victory_betting_record;
    }
...
//        ClassicsHeader.REFRESH_HEADER_LASTTIME = getString(R.string.xlistview_header_last_time);
    ...
    public void initData() {
        paymentRecordAdapter = new VictoryBettingRecordAdapter(this,"1");
        getHttpInfo();
    }
...
//            return String.valueOf(sdf.parse(date).getTime());
    ...
    private void getHttpInfo() {
        ...
        final pos_GetTicketQuery.BettingInfo payRecordBean = new pos_GetTicketQuery.BettingInfo("00",pageNo + "",starts,ends);
        pos_GetTicketQuery.DataBean dataBean = new pos_GetTicketQuery.DataBean(payRecordBean);
        pos_GetTicketQuery pos_getPaymentRecordQuery = new pos_GetTicketQuery(account_name, account_password, "3", dataBean);
        String s1 = new Gson().toJson(pos_getPaymentRecordQuery);
        OkGo.<String>post(MyUrl.pos_GetTicketQuery)
                .upJson(s1)
                    ...
                    public void vOnSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("code").equals("00000")) {
                                ...
                                victoryBettingBean = new Gson().fromJson(response.body(), VictoryBettingBean.class);
                                payListBeans.addAll(victoryBettingBean.getBettingList());
