package com.jc.lottery.view.datepicker.time;
...
/**
 * 时间选择器，弹出框
 * Created by lr on 2018/1/6.
 */
public class DatePickerDialogFragment extends DialogFragment {

	protected DatePicker mDatePicker;
	private TextView tvDialogTimeTitle;
	...
	public void setOnDateChooseListener(OnDateChooseListener onDateChooseListener,String title) {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
		...
		mDatePicker.setMaxDate(System.currentTimeMillis() - (1000 * 60 * 60 *24));
		tvDialogTimeTitle = view.findViewById(R.id.tv_dialog_time_title);
		tvDialogTimeTitle.setText(title + "");
