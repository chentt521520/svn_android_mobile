...
public class WalletRecordActivity extends BaseActivity {
    ...
    public void getPreIntent() {
        walleType = getIntent().getStringExtra("walleType");
    }
...
//            return String.valueOf(sdf.parse(date).getTime());
    ...
    private void getHttpInfo() {
        ...
        final pos_GetWalleQueryInfo.WalleInfo walleInfo = new pos_GetWalleQueryInfo.WalleInfo(walleType,"", pageNo + "",starts,ends, TimeUtils.get10IntTimeStamp() + "");
