...
public class RedeemQueryBean {
    ...
    public RedeemQueryBean(String accountName,String password, DataBean data) {
        this.interfaceCode = "redeemQuery";
        this.channel = "3";
    ...
    public static class OrderInfo{
        ...
        public OrderInfo(String order_code) {
