 ...
 * @ author: lr
 */
public class pos_GetSettlementCheck {
    /**
    ...
    public pos_GetSettlementCheck(String accountName, String password , String channel, DataBean data) {
        this.interfaceCode = "check";
