...
public class SettleQueryInfo {
    ...
    public String getLottoSales() {
        return lottoSales;
    }

    public void setLottoSales(String lottoSales) {
    ...
    public void setCashBets(String cashBets) {
    ...
    public void setSaleBets(String saleBets) {
    ...
    public void setSettleQuota(String settleQuota) {
