...
import com.jc.lottery.activity.money.RechargeNewDetailActivity;
import com.jc.lottery.activity.money.RechargeSuccessActivity;
...
public class RechargeLotteryActivity extends BaseActivity {
...
//    EditText etRechargePhone;
    ...
    @BindView(R.id.tv_recharge_game_type)
    TextView tvRechargeGameType;
    ...
    public static RechargeLotteryActivity ins;
    private String role = "";
    private String type = "";
...
//        instant = SPUtils.look(this, SPkey.instantRecharge);
        ...
        if (type.equals("")) {
            tvRechargeGameType.setText(getString(R.string.lotto));
        }else {
            tvRechargeGameType.setText(getString(R.string.jackpot));
        }
        ...
        if (role.equals("fxs")) {
            llyRechargeOne.setVisibility(View.GONE);
//            rechargeType = 1;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_recharge_submit:
                ...
                if (phone.equals("") && rechargeType != 4) {
...
//        llyRechargeRecharging.setVisibility(View.VISIBLE);
        ...
        pos_PayRecharge.PayInfo payInfo = new pos_PayRecharge.PayInfo(gameType, payMethod, payMoney, amount, phone);
...
//                                    intent.setClass(RechargeLotteryActivity.this, RechargeNewDetailActivity.class);
...
//                            }
                            if (jsonObject.getString("code").equals("00000")) {
                                if (rechargeType != 4) {
                                    ...
                                    intent.setClass(RechargeLotteryActivity.this, RechargeSuccessActivity.class);
                                    startActivity(intent);
//                                    ToastUtils.showShort(getString(R.string.submit_successfully));
//                                    finish();
                                }
