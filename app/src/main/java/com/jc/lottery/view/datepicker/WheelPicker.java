package com.jc.lottery.view.datepicker;
...
import com.jc.lottery.view.datepicker.util.LinearGradient;
...
public class WheelPicker<T> extends View {
	...
	private void initAttrs(Context context, @Nullable AttributeSet attrs) {
		...
		mTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_itemTextSize,
				getResources().getDimensionPixelSize(R.dimen.trend_x_text_size));
