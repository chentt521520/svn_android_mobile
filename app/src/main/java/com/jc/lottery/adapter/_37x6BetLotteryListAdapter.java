...
public class _37x6BetLotteryListAdapter extends BaseBetLotteryListAdapter implements ObservableAdapter {
    ...
    public _37x6BetLotteryListAdapter(Context context, TextView tv_money, TextView tv_zhushu001, TextView tv_beishu, TextView tv_qishu) {
        super(context);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (TextUtils.equals(payment.getZuheType(), "90选5")) {
            ...
            price = FormatUtil.addComma(payment.getBetting() * Config.OneBetPrice);
        }
