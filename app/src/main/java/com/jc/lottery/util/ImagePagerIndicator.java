...
public class ImagePagerIndicator extends LinearLayout {
     ...
     * 默认可见tab的数量
     */
    public int DEFAULT_TAB_VISABLE_COUNT = 3;
    /**
     * 选中与没有选中的颜色
     */
    ...
    public void setDEFAULT_TAB_VISABLE_COUNT(int DEFAULT_TAB_VISABLE_COUNT) {
        this.DEFAULT_TAB_VISABLE_COUNT = DEFAULT_TAB_VISABLE_COUNT;
    }
    ...
    public ImagePagerIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorHeight = (int) typedArray.getDimension(R.styleable.ImagePagerIndicator_indicator_height,dp2px(2));
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.ImagePagerIndicator_indicator_height,dp2px(42));
        ...
        if(drawable instanceof BitmapDrawable) {
            ...
            mImageBitmap = Bitmap.createBitmap(mIndicatorWidth,mIndicatorHeight,
