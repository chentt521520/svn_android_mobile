...
public class LotterySettlementRecordFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    public LotterySettlementRecordFragment(String settleStatus) {
    ...
    public void initListener() {
        xlvSettlement.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("orderCode", settlementRecordBeanList.get(position - 1).getOrderCode());
                intent.setClass(getActivity(), LotterySettlementDetailActivity.class);
...
//                getHttpInfo();
    ...
    private void getHttpInfo() {
        ...
        pos_GetSettlementRecord.DataBean.SettlementInfo settlementInfo = new pos_GetSettlementRecord.DataBean.SettlementInfo("", "", pageNo + "", settleStatus);
        ...
        OkGo.<String>post(MyUrl.settleSettleRecord)
                .upJson(s1)
