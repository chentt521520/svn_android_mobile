...
/**
 * @ Create_time: 2020/04/09 on 17:23.
 * @ description：结算时间查询
 * @ author: lr
 */
public class pos_GetSettleTimeQuery {
    /**
    ...
    public pos_GetSettleTimeQuery(String accountName, String password , String channel, DataBean data) {
        this.interfaceCode = "settleTime";
