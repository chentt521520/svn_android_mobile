 ...
 * 投注成功页面
 */
public class VictoryBettingSuccessActivity extends BaseActivity implements OnClickListener {
...
//    private TextView tV_successjixulottery;
    ...
    public int getLayoutId() {
        ...
        return R.layout.victory_bettingsuccess;
    }
...
//        String gamename = TransfromUtils.GameAlias2Name(VictoryBettingSuccessActivity.this, resp_order_success.getData().getOrderInfo().getGameAlias(), "彩票");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_successmylottery:
                Intent intent1 = new Intent(VictoryBettingSuccessActivity.this, VictoryBettingRecordActivity.class);
            ...
            case R.id.ll_successjixulottery:
                if (TextUtils.equals(Constant.GAME_ALIAS_90X5, gameAlias)) {
                    Intent intent = new Intent(VictoryBettingSuccessActivity.this, s90x5Activity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return;
                } else if (TextUtils.equals(Constant.GAME_ALIAS_37X6, gameAlias)) {
                    Intent intent = new Intent(VictoryBettingSuccessActivity.this, _37x6SelectNumActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return;
                } else {
                    Intent intent = new Intent(VictoryBettingSuccessActivity.this, VictoryDefeatActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    VictoryBettingSuccessActivity.this.finish();
                }
