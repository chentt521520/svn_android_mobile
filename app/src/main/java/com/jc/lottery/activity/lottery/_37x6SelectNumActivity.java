...
public class _37x6SelectNumActivity extends BaseActivity implements AdapterView.OnItemClickListener, SensorEventListener {
    ...
    public int getLayoutId() {
        return R.layout.activity_37x6_select_num;
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (sensorType == Sensor.TYPE_ACCELEROMETER) {
            if ((Math.abs(values[0]) > Config.ShakeAccuracy || Math.abs(values[1]) > Config.ShakeAccuracy || Math.abs(values[2]) > Config.ShakeAccuracy)) {
                ...
                // 摇动手机后，再伴随震动提示~~
                VibratorUtils.Vibrate(_37x6SelectNumActivity.this, 400);
                randomBall();
            }
        }
    }
...
//    初始化数据
        CountBetsUtils.getnums(37, numsList1);
                ...
                .execute(new vStringCallback(this) {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        if (ProgressUtil.getProgressDialog() == null) {
                            ProgressUtil.showProgressDialog(_37x6SelectNumActivity.this, getString(R.string.waitting));
                        }
                    }
...
//        s37x6_tv_money.setText(MoneyUtil.getIns().GetMoney(FormatUtil.addComma(Config.OneBetPrice * s)));
        s37x6_tv_money.setText(MoneyUtil.getIns().GetMoney(FormatUtil.addComma(Config.s37x6_R007_NoteMoney_min * s)));
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.button_sure:
                ...
                if (selectList1.size() >= n) {
                    ...
                    suoShui.setType(getString(R.string.s37x6name));
                    suoShui.setZuheType(getString(R.string.s37x6name));
                    ...
                    if ("ballHaoMa".equals(strBallHaoMa)) {
                        ...
                        intent.putExtra("type", getString(R.string.s37x6name));
                        intent.putExtra("zuhe", getString(R.string.s37x6name));
                        sendBroadcast(intent);
                        finish();
                    } else {
                        Intent intent = new Intent(_37x6SelectNumActivity.this, _37x6BettingActivity.class);
                        intent.putParcelableArrayListExtra("haoma", arrayList);
                        intent.putExtra("type", getString(R.string.s37x6name));
                        intent.putExtra("zuhe", getString(R.string.s37x6name));
...
//                    ToastUtils.showShort("每位数字至少选择" + n + "个");
            ...
            case R.id.lin_s37x6_zoushitu:
                Intent intent = new Intent(_37x6SelectNumActivity.this, _37x6HistoryQueryActivity.class);
                startActivity(intent);
                break;
        }
    }
    ...
    private void GetSelectGameAdd() {
        String account_name = SPUtils.look(this, SPkey.username);
        pos_SelectGameAdd.GameInfo gameInfo = new pos_SelectGameAdd.GameInfo("37x6");
