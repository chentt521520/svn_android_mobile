 ...
 * @ author: lr
 */
public class CashPrizeQueryBean {
    /**
    ...
    public CashPrizeQueryBean(String accountName, DataBean data) {
        this.interfaceCode = "cashPrizeQuery";
    ...
    public static class OrderInfo{
        ...
        public OrderInfo(String gameAlias, String orderCode) {
