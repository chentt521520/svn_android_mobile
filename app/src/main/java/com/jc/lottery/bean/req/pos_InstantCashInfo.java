 ...
 * @ author: lr
 */
public class pos_InstantCashInfo {
    /**
     * interfaceCode : cash
    ...
    public pos_InstantCashInfo(String accountName, String password , String channel, DataBean.OrderInfo orderInfo) {
        this.interfaceCode = "cash";
    ...
    public static class DataBean {
        ...
        public static class OrderInfo {
            ...
            public OrderInfo(int accountId, String securityCode, String manualCode, String logisticsCode, String terminalNum) {
