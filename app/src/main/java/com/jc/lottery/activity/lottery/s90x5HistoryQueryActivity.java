...
public class s90x5HistoryQueryActivity extends BaseActivity {
    @BindView(R.id.lv_90x5_history)
    ListView lv90x5History;
    ...
    public int getLayoutId() {
        return R.layout.activity_90x5_history;
    }
    ...
    private void getHttp(){
        String account_name = SPUtils.look(s90x5HistoryQueryActivity.this, SPkey.username);
                ...
                .execute(new vStringCallback(this) {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        if (ProgressUtil.getProgressDialog() == null) {
                            ProgressUtil.showProgressDialog(s90x5HistoryQueryActivity.this, getString(R.string.waitting));
                        }
                    }
                    ...
                    public void vOnSuccess(Response<String> response) {
                        ...
                        _36x7HistoryAdapter adapter = new _36x7HistoryAdapter(s90x5HistoryQueryActivity.this, datas);
