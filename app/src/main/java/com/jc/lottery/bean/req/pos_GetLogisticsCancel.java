 ...
 * @ author: lr
 */
public class pos_GetLogisticsCancel {
    /**
    ...
    public pos_GetLogisticsCancel(String accountName, String password , String channel, DataBean data) {
        this.interfaceCode = "cancel";
    ...
    public static class DeliveryInfo{
        ...
        public DeliveryInfo(String orderCode) {
