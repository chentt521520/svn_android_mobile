 ...
 * 我的乐透页面
 */
public class MyLottoryActivity extends BaseActivity {
...
//    PercentLinearLayout llyLottoryTopFxs;
    ...
    private MyLotteryListAdapter myImmediateAdapter;

    @Override
    public int getLayoutId() {
        return R.layout.activity_my_lottorys;
    }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_my_lottery_settlement_list:
                intent.setClass(this, SettlementListActivity.class);
                startActivity(intent);
                break;
...
//                                tvMyLotteryBalances.setText(MoneyUtil.getIns().GetMoney(jsonObject.getString("lottoBalance")) + getString(R.string.price_unit));
                                ...
                                tvMyLotterySurplusQuota.setText(MoneyUtil.getIns().GetMoney(jsonObject.getString("surplusLimit")) + getString(R.string.price_unit));
        ...
        if (type) {
            ...
            btLockPopYes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String json = SPUtils.look(MyLottoryActivity.this, SPkey.encryptedState);
                    ...
                    SPUtils.save(MyLottoryActivity.this, SPkey.encryptedState, s);
...
//                    showPopView(pos,2,type,name);
    ...
    private void showInfoView() {
        ...
        if (getPermissionsUtil.getPermissions("yddltdjjl")) {
            immediateBeanList.add(new MyImmediateBean(2, getString(R.string.reward_record), R.drawable.my_jkc_six, isState("yddltdjjl"), "yddltdjjl"));
        }
        if (getPermissionsUtil.getPermissions("yddlttzjl")) {
            immediateBeanList.add(new MyImmediateBean(3, getString(R.string.bethistiory), R.drawable.tzjl, isState("yddlttzjl"), "yddlttzjl"));
        }
        if (getPermissionsUtil.getPermissions("yddltjs")) {
            immediateBeanList.add(new MyImmediateBean(4, getString(R.string.settlement), R.drawable.my_lottory_three, isState("yddltjs"), "yddltjs"));
        }
        ...
        if (getPermissionsUtil.getPermissions("yddltxl")) {
            immediateBeanList.add(new MyImmediateBean(6, getString(R.string.sales_volume_statistics), R.drawable.sjtj, isState("yddltxl"), "yddltxl"));
        }
        if (getPermissionsUtil.getPermissions("yddltjsjl")) {
...
//            tvMyLotteryMoneys.setVisibility(View.VISIBLE);
        ...
        if (immediateBeanList.size() > 0) {
            myImmediateAdapter = new MyLotteryListAdapter(this);
