...
public class SettleTimeQuery {
    ...
    public SettleTimeQuery(String accountName, String password , String channel, DataBean data) {
        this.interfaceCode = "settleTimeQuery";
    ...
    public static class SettlementInfo{
        ...
        public SettlementInfo(String gameAlias) {
