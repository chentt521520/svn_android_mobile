...
//        ClassicsHeader.REFRESH_HEADER_LASTTIME = getString(R.string.xlistview_header_last_time);
    ...
    public void initData() {
        paymentRecordAdapter = new VictoryBettingRecordAdapter(this,"2");
        getHttpInfo();
    }
...
//            return String.valueOf(sdf.parse(date).getTime());
    ...
    private void getHttpInfo() {
        ...
        final pos_GetTicketQuery.BettingInfo payRecordBean = new pos_GetTicketQuery.BettingInfo("01",pageNo + "",starts,ends);
