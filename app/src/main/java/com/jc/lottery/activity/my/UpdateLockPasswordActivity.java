...
import com.jc.lottery.bean.req.PasswordSecondaryUpdateBean;
...
public class UpdateLockPasswordActivity extends BaseActivity {
    ...
    public void initView() {
        tvPasswordTitle.setText(getString(R.string.change_secondary_password));
    }
    ...
    private void passwordUpdateHttp(final String oldPassword, String newPassword) {
        ...
        PasswordSecondaryUpdateBean passwordUpdateBean = new PasswordSecondaryUpdateBean(account_name, md5OrAes(oldPassword), md5OrAes(newPassword));
        String s = new Gson().toJson(passwordUpdateBean);
        OkGo.<String>post(MyUrl.password_secondaryUpdate)
                .upJson(s)
