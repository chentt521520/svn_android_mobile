 ...
 * @ author: lr
 */
public class pos_GetOrderTracking {
    /**
    ...
    public pos_GetOrderTracking(String accountName, String password , String channel, DataBean data) {
        this.interfaceCode = "orderTracking";
    ...
    public static class OrderInfo{
        ...
        public OrderInfo(String schemeNum, String cartonNo, String bookNum) {
