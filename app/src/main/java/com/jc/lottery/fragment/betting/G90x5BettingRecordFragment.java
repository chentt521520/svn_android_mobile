...
public class G90x5BettingRecordFragment extends BaseFragment {
...
//        }
        recordAdapter = new BettingRecordAdapter(getActivity(),"90x5","1");
...
//        String terminalNum = SPUtils.look(getActivity(), SPkey.terminalId);
        HistoryBettingQueryBean.BettingInfo bettingInfo = new HistoryBettingQueryBean.BettingInfo("90x5", "01","1");
