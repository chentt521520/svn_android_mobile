...
public class G36x7LotteryRecordFragment extends BaseFragment {
    ...
    public G36x7LotteryRecordFragment(String game) {
        this.game = game;
    }
...
//        }
    ...
    public void getHttpInfo() {
        ...
        pos_Screen37x6History.ColorPeriodInfo colorPeriodInfo = new pos_Screen37x6History.ColorPeriodInfo(game);
        ...
        OkGo.<String>post(MyUrl.screen_90x5_History)
                ...
                .execute(new vStringCallback(getActivity()) {
                    ...
                    public void vOnSuccess(Response<String> response) {
                        ...
                        recordAdapter = new LotteryRecordAdapter(getActivity(),game);
