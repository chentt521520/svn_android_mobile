...
public class G36x7BettingRecordFragment extends BaseFragment {
    ...
    public G36x7BettingRecordFragment(String game) {
        this.game = game;
    }
...
//        for (int i = 0; i < 15; i++) {
//            list.add("No." + (31274875 + i));
//        }
        recordAdapter = new BettingRecordAdapter(getActivity(),game,"1");
    ...
    private void getHttpInfo() {
        ...
        HistoryBettingQueryBean.BettingInfo bettingInfo = new HistoryBettingQueryBean.BettingInfo(game, "01","1");
...
//                                List<BettingListInfo> permissionsList = new ArrayList<>();
