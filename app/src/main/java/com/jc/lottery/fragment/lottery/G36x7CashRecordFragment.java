...
public class G36x7CashRecordFragment extends BaseFragment {
    ...
    public G36x7CashRecordFragment(String game) {
        this.game = game;
    }
...
//        }
        recordAdapter = new BettingRecordAdapter(getActivity(),game,"2");
    ...
    private void getHttpInfo() {
        ...
        HistoryBettingQueryBean.BettingInfo bettingInfo = new HistoryBettingQueryBean.BettingInfo(game, "03","1");
