...
public class pos_GetLotterySettlementDetails {
    ...
    public pos_GetLotterySettlementDetails(String accountName, String password , String channel, DataBean.SettlementInfo settlementInfo) {
        this.interfaceCode = "settleDetails";
    ...
    public static class DataBean {
        ...
        public static class SettlementInfo {
            ...
            public SettlementInfo(String orderCode) {
