 ...
 * 37 选 6 近期开奖查询
 */
public class _37x6HistoryQueryActivity extends BaseActivity {
    ...
    private void getHttp(){
        String account_name = SPUtils.look(_37x6HistoryQueryActivity.this, SPkey.username);
        pos_Screen37x6History.ColorPeriodInfo colorPeriodInfo = new pos_Screen37x6History.ColorPeriodInfo("37x6");
        ...
        LogUtils.e("  请求参数  " + s);
        OkGo.<String>post(MyUrl.screen_37x6_History)
                .upJson(s)
                .execute(new vStringCallback(this) {
                    ...
                    public void onStart(Request<String, ? extends Request> request) {
                        ...
                        if (ProgressUtil.getProgressDialog() == null) {
                            ProgressUtil.showProgressDialog(_37x6HistoryQueryActivity.this, getString(R.string.waitting));
                        }
                    }
                    ...
                    public void vOnSuccess(Response<String> response) {
                        ...
                        _36x7HistoryAdapter adapter = new _36x7HistoryAdapter(_37x6HistoryQueryActivity.this, datas);
